        ...
        <div className="flex justify-between items-center">
          ...
          <a href="#" className="flex items-center gap-2 group cursor-pointer">
            <div className="w-12 h-12 relative transform group-hover:scale-110 transition-transform duration-300">
              <Image
                src="/logo-caniches.png"
                alt="Caniches con Amor Logo"
                width={48}
                height={48}
            ...
            <div>
              <h1 className="text-lg font-bold text-white leading-none hidden sm:block">
                Caniches
              </h1>
              <p className="text-xs font-semibold hidden sm:block" style={{ color: '#D4AF37' }}>
                Premium
              </p>
            </div>
          </a>
